...
def generate_pdf(dest, start, arrival, departure, days, members, dist, mode, hotel, room_type, rooms, food_list, activities_list, total_breakdown, total):
    ...
    pdf.cell(0, 10, txt="SAFARNAMA", ln=True, align='C')
    pdf.set_font("Arial", 'I', 10)
    pdf.cell(0, 10, txt="Your Journey, Our Passion", ln=True, align='C')
    pdf.ln(15)
    ...
    pdf.cell(0, 12, txt=f"GRAND TOTAL: Rs. {total:,.2f}", ln=True, align='C')

    # Footer
    pdf.set_y(-20)
    pdf.set_font("Arial", 'I', 12)
    pdf.set_text_color(181, 109, 51)
    pdf.cell(0, 10, txt="Generated by SAFARNAMA TRAVEL SERVICES", align='C')
    pdf.cell(0, 10, txt="DEVELOPED BY MAYUR B GUND AND ROHIT J. KHOKALE  ", align='C')
